...
TESTING_MODE = False  # WARNING: DO NOT RUN WITH THIS TRUE IN PRODUCTION!
DEBUG = TESTING_MODE
...
ALLOWED_HOSTS = ['localhost' if TESTING_MODE else 'blodge.server.ssm.webapps.uplandsdynamic.com']
CORS_ORIGIN_ALLOW_ALL = True  # only set True for testing purposes
CORS_ALLOW_CREDENTIALS = True
CORS_ORIGIN_WHITELIST = ['http://localhost' if TESTING_MODE else 'https://blodge.server.ssm.webapps.uplandsdynamic.com', 'https://blodge.ssm.webapps.uplandsdynamic.com']
CSRF_TRUSTED_ORIGINS = ['https://*.uplandsdynamic.com']
...
Q_CLUSTER = {
    'name': 'Blodge.SimpleStockManagement',
...
if not TESTING_MODE:
    DATABASES = {
        'default': {
            ...
            'NAME': 'blodge-ssm',
            'USER': 'troy',
            'PASSWORD': 'aerrt(34**rtkjsgn6^24524',
            'HOST': 'localhost',
            'PORT': '5432',
        }
    }
...
DEFAULT_FROM_EMAIL = "brentlodge.ssm@mail.uplandsdynamic.com"
ANYMAIL = {
    'IGNORE_UNSUPPORTED_FEATURES': True,
    #'SPARKPOST_API_KEY': '1edbdd33d1bda88aab3e07f6be1e3f83f4de1d60',
    'SPARKPOST_API_KEY': '49d72227c8dc79706be8c558a12fd7381ce4f1ca',
...
LOG_FILE = '/var/log/django/blodge.ssm.log'
