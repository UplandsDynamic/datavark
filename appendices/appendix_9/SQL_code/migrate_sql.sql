...
-- Create model Color
--
CREATE TABLE "ie_color" ("id" bigint NOT NULL PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY, "color" varchar(200) NOT NULL UNIQUE);
--
-- Create model Date
--
CREATE TABLE "ie_date" ("id" bigint NOT NULL PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY, "date" date NOT NULL UNIQUE);
--
-- Create model Loc
--
CREATE TABLE "ie_loc" ("id" bigint NOT NULL PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY, "place_name" varchar(200) NOT NULL UNIQUE, "coordinates" geometry(POINT,4326) NOT NULL UNIQUE);
--
-- Create model Time
--
CREATE TABLE "ie_time" ("id" bigint NOT NULL PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY, "time" time NOT NULL UNIQUE);
--
-- Create model Type
--
CREATE TABLE "ie_type" ("id" bigint NOT NULL PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY, "type" varchar(200) NOT NULL UNIQUE);
--
-- Create model Report
--
...
CREATE INDEX "ie_color_color_fad8fcec_like" ON "ie_color" ("color" varchar_pattern_ops);
CREATE INDEX "ie_loc_place_name_8f0fb2a7_like" ON "ie_loc" ("place_name" varchar_pattern_ops);
CREATE INDEX "ie_loc_coordinates_1d8f18e6_id" ON "ie_loc" USING GIST ("coordinates");
CREATE INDEX "ie_type_type_37eaa9ba_like" ON "ie_type" ("type" varchar_pattern_ops);
