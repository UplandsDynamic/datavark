...
ALLOWED_HOSTS = ["localhost", "datareaper.uk"]
CORS_ORIGIN_ALLOW_ALL = True  # only set True for testing purposes
CORS_ALLOW_CREDENTIALS = True
CORS_ORIGIN_WHITELIST = ["http://localhost", "https://datareaper.uk"]
CSRF_TRUSTED_ORIGINS = ["https://*.datareaper.uk", "https://datareaper.uk"]
...
WSGI_APPLICATION = "DataReaper.wsgi.application"
...
CACHE_MIDDLEWARE_KEY_PREFIX = "datareaper_server"
MIDDLEWARE.insert(
...
### logging
LOG_FILE = (
    "/var/log/django/datareaper.log"  # this directory & file needs to be created first!
)
LOGGING = {
    "version": 1,
